    ...
    <div class="main-header__container container">
        ...
        <nav class="user-menu">
                ...
                <div class="user-menu__image">
                    <img src="<?= $_SESSION['user']['photo'] ?>" width="40" height="40" alt="Пользователь">
                </div>
...
<footer class="main-footer">
    <nav class="nav">
        <ul class="nav__list container">
            <li class="nav__item">
                <a href="all-lots.php"><?= $categories[0] ?></a>
            </li>
            <li class="nav__item">
                <a href="all-lots.php"><?= $categories[1] ?></a>
            </li>
            <li class="nav__item">
                <a href="all-lots.php"><?= $categories[2] ?></a>
            </li>
            <li class="nav__item">
                <a href="all-lots.php"><?= $categories[3] ?></a>
            </li>
            <li class="nav__item">
                <a href="all-lots.php"><?= $categories[4] ?></a>
            </li>
            <li class="nav__item">
                <a href="all-lots.php"><?= $categories[5] ?></a>
            </li>
        </ul>
    </nav>
