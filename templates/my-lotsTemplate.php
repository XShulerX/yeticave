    ...
    <table class="rates__list">
        ...
        <tr class="rates__item">
            <td class="rates__info">
                ...
                <h3 class="rates__title"><a href="lot.php">DC Ply Mens 2016/2017 Snowboard</a></h3>
            </td>
            <td class="rates__category">
                Доски и лыжи
            </td>
        ...
        <tr class="rates__item rates__item--win">
            <td class="rates__info">
                ...
                <div>
                    <h3 class="rates__title"><a href="lot.php">Крепления Union Contact Pro 2015 года размер L/XL</a></h3>
        ...
        <tr class="rates__item">
            <td class="rates__info">
                ...
                <h3 class="rates__title"><a href="lot.php">Ботинки для сноуборда DC Mutiny Charocal</a></h3>
            </td>
            <td class="rates__category">
                Ботинки
            </td>
        ...
        <tr class="rates__item rates__item--end">
            <td class="rates__info">
                ...
                <h3 class="rates__title"><a href="lot.php">Куртка для сноуборда DC Mutiny Charocal</a></h3>
            </td>
            <td class="rates__category">
                Одежда
            </td>
        ...
        <tr class="rates__item rates__item--end">
            <td class="rates__info">
                ...
                <h3 class="rates__title"><a href="lot.php">Маска Oakley Canopy</a></h3>
            </td>
            <td class="rates__category">
                Разное
            </td>
